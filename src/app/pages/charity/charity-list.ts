export const charityList = [
    ...
    {
        name: 'Комунальное учреждение "Одесская специализировання общеобразовательная школа-интернат №97 I-II ступеней"',
        goal: 'Обеспечение мебелью',
        summ: '40 000 грн.',
        add: '<img src="/assets/images/mebel-internat.jpg" alt="Обеспечение мебелью" class="responsive-image popup">'
    },
    {
        name: 'Полюга Б.',
        goal: 'Покупка беговой дорожки для реабилитации',
        summ: '11 599 грн.',
        add: '<img src="/assets/images/begovaja-dorojka.jpg" alt="Покупка беговой дорожки для реабилитации" class="responsive-image popup">'
    },
    {
        name: 'Макарчук Н.В.',
